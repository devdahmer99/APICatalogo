...
namespace APICatalogo.Migrations
{
    ...
    [Migration("20240813231444_CatalogoProduto")]
    partial class CatalogoProduto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoriaProduto", b =>
                {
                    b.HasOne("APICatalogo.Domain.Categoria", null)
                        .WithMany()
                        .HasForeignKey("CategoriasCategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APICatalogo.Domain.Produto", null)
                        .WithMany()
